...
//		{
		...
		//echo 'xxxxx';
		$cache_dirx = './feedmenow_rsscachefiles';
		
		if (!file_exists($cache_dirx)) {
			mkdir($cache_dirx, 0777);
		}
		
		//$this->recursiveChmod('tmp',  0777, 0777); 
			$cache_file =$cache_dirx . '/rsscache_' . md5($rss_url);
