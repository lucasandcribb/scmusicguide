	...
	function videoCreateGallery($videolist, $galleryID = false, $slide_show = false, $place_holder = "main") {
	    ...
	    foreach ($videolist as $video) {
			...
			if($slide_show) {
				...
				$out .= '<div class="video-link-container vid-'.$index.'" rel="'.$index.'" style="float:left;margin-right:10px;"><div class="video-gallery-thumbnail-box" style="padding:0px;" id="vide-file-'.$index.'">';
